...
//      System.out.println(fractionNumerator+":"+fractionDenominator);
    ...
    public String toString() {  
    	return intNum+"   ("+Math.abs(numerator) + "/" + Math.abs(denominator)+")" ;  
    } 
    
    public FractionForAdd multiply(long x) {  
        long fractionNumerator = numerator * x;  
        long fractionIntNum = intNum*x;
        return new FractionForAdd(fractionNumerator,denominator,fractionIntNum);  
    } 
